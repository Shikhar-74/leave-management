...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel — gradient */}
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-indigo-600 via-purple-600 to-indigo-800 items-center justify-center p-12">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl bg-linear-to-br from-indigo-600 to-purple-600 text-white text-sm font-medium hover:from-indigo-700 hover:to-purple-700 focus:ring-2 focus:ring-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
            >
